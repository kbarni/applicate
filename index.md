...
Create a repository or a website folder in your project.
...
description: "..."
header_image: "assets/images/screenshot.png"
download_url: "https://github.com/username/project"
download_text: "Get it on GitHub"
...
Clone the repository, edit the `_config.yml` file and the `index.md`; add your header image in `assets/images` and build the site using `jekyll build`.
